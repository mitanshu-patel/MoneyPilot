    ...
    public static class ModelBuilderExtensions
    {
        public static void Seeding(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ExpenseCategory>().HasData(
                ...
                new ExpenseCategory { Id = 3, Category = "Subscriptions", HasAutoPayment = true },
                new ExpenseCategory { Id = 4, Category = "Rent" },
                new ExpenseCategory { Id = 5, Category = "EMI", HasAutoPayment = true },
            ...
            modelBuilder.Entity<InvestmentCategory>().HasData(
                ...
                new InvestmentCategory { Id = 2, Category = "Mutual Funds/SIPs", HasAutoPayment = true },
